...
export default function CreatedEventCard({ event }: CreatedEventCardProps) {
    ...
    const handleUpdate = () => {
        ...
        toast.info(`Update functionality for event: ${title}`);
    };
                    ...
                    {showMarkComplete ? (
                        <div className="ml-auto">
                            <Button
                                ...
                                disabled={isPending}
                                className="text-white bg-green-600 hover:bg-green-700 disabled:bg-gray-400 disabled:cursor-not-allowed flex items-center gap-1"
                            >
                        ...
                        <div className="ml-auto">
                            <Button
                                ...
                                className={`text-white flex items-center gap-1 ${isDeleteDisabled || isPending
                        ...
                        <div className="ml-auto flex gap-2">
                            <Button
                                ...
                                className={`text-white flex items-center gap-1 ${isUpdateDisabled
                                        ? "bg-gray-400 hover:bg-gray-400 cursor-not-allowed"
